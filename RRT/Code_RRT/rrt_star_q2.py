...
class RrtStar:
    ...
    def planning(self):
        ...
        for k in range(self.iter_max):
            ...
            if iter_goal == None: index = self.search_goal_parent()
        ...
        return self.path, iter_goal, collisions
...
def main():
    ...
    for step in steps:
        ...
        for i in range(times_per_stepsize):
            ...
            rrt_star = RrtStar(environment, x_start, x_goal, step, 0.10, 20, 2000)

            path, nb_iter, collisions = rrt_star.planning()
